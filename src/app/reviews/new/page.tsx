            ...
            <div className="p-6 lg:p-8">
              ...
              <div className="mt-6">
                <ReviewForm
                  ...
                  showGuidancePanels={false}
                />
              </div>
            </div>

            <aside className="space-y-5 border-t border-brand-100/70 bg-gradient-to-b from-brand-50/35 to-white p-6 lg:border-t-0 lg:border-r lg:p-8">
              <PlaceholderVisual
                label="מהשטח, כמו שזה באמת הרגיש"
                caption="שיתוף קצר שלך יכול לעזור למישהו אחר להבין אם זה מתאים לו"
                variant="hero"
                className="aspect-[1/1.02] w-full"
              />
