      ...
      <div className="rounded-2xl bg-brand-50 p-4 text-sm leading-7 text-slate-600">
        {accountIntent === "representative"
          ...
          : accountIntent === "resident"
            ? "החשבון מאפשר לשמור מועדפים ולעקוב אחרי מחלקות. שליחת ביקורת פתוחה גם בלי הרשמה, ותאומת בנפרד מול צוות האתר."
            : "החשבון מיועד לגלישה נוחה, שמירת מועדפים וגישה מהירה למוסדות ולמחלקות שמעניינים אותך."}
      </div>
