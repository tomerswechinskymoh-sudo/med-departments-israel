export const REVIEW_GUIDELINES = [
  ...
  "נשמח לשמוע גם חוויות חיוביות, נקודות חוזק, יחס אישי, הוראה טובה או חשיפה קלינית משמעותית.",
  "אפשר לציין גם קשיים, אבל נסו לנסח אותם בצורה בונה ועוזרת למי שמגיע אחריכם.",
