...
export const ENT_FELLOWSHIPS: FellowshipDictionaryEntry[] = [
  ...
  },
  {
    ...
    aliases: ["head and neck oncology", "head and neck surgery", "גידולי ראש צוואר", "כירורגיית ראש וצוואר"],
    alias_type: "subspecialty",
    match_strength: "strong",
    crawler_priority: 1,
    specialty_group: "ENT",
  ...
  },
  {
    ...
    aliases: ["microvascular reconstruction", "free flap", "reconstructive surgery", "שחזור מיקרווסקולרי", "מתלה חופשי"],
